    ...
    return(
        <nav className="flex  justify-between items-center border-b px-10">
            ...
            <ul className="flex  w-8/12 gap-4 text-dark-blue items-center">
                ...
                <li><Link href='ads/post-ads' className="hover:bg-dark-blue  hover:text-milk py-4 px-2 ">POST ADs</Link></li>
                ...
                <li><Link href='/login' className="border border-dark-blue py-3 px-3 rounded">Login</Link></li> 
